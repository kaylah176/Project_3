...
ownership_token_address = '0xBbA8b677bBC96CbFB13E57A35F079006B8743456'
...
real_estate_nft_address = '0xcf2311cC0D867a677A3eC9FfD970cef1A4f88017'
...
st.subheader("Update Property Description")
...
if st.button("Update Description"):
    ...
    tx_receipt = w3.eth.waitForTransactionReceipt(tx_hash)
    st.write("Updated property description")
